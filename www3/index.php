...
<div class='foreground-container grey'>
  <div class='foreground'>
    <h1>Get Our Latest Marketing Strategies</h1><br /><br /><br />
 <div id='main-content'>
      <div class='yui3-g'>
	    ...
	    <div class='content-box-foreground media-feed-box'>
              <div class='media-feed-title'>
	        <img src='img/tweets-icon.png' class='media-feed-icon'/><h1 class='i201-tweets'></h1>
              </div>
	  ...
	  then we decide to do something completely different and start a company with some poncy name 201Digital. There is a plan to all the madness however</p>
	    ...
	    <div class='content-box-foreground media-feed-box'>
	      <div class='media-feed-title'>
	        <img src='img/blog-icon.png' / class='media-feed-icon'><h1 class='i201-blog'></h1>
              </div>
	    ...
	    <div class='content-box-foreground media-feed-box'>
	      <div class='media-feed-title'>
	        <img src='img/latest-icon.png' class='media-feed-icon'/><h1 class='i201-latest'></h1>
              </div>
	      <p>Get our bi-weekly catch up of the latest marketing trends and campaigns from across the Net.</p>
...
<div class='foreground-container white'>
  <div class='foreground'>
    <h1>Get Our Latest Marketing Strategies</h1><br /><br /><br />
 <div id='main-content'>
      <div class='yui3-g'>
...
<div class='foreground-container pink'>
  <div class='foreground'>
    <h1>Get Our Latest Marketing Strategies</h1><br /><br /><br />
 <div id='main-content'>
      <div class='yui3-g'>
